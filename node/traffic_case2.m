...
models = {
    ...
    -250, 100/3.6, IDModel(struct('a_max',1.5, 'b_max',1.67, 'v_0',130/3.6, 'T',1.8, 'h_0',2, 'delta',4, 'L', 4.5));
};
...
print('Resources/n_car_velocity_case2','-depsc');
...
xlabel('t[s]','fontsize',12')
print('Resources/n_car_headway_case2','-depsc');