...
\psfrag{Standard deviation [s]}{Standard deviation [s]}

\psfrag{Original}{\scriptsize $t_0$}
\psfrag{amax}{\scriptsize $\amax$}
\psfrag{T}{\scriptsize $T$}
\psfrag{h0}{\scriptsize $h_0$}
\psfrag{lcduration}{\scriptsize $t_{\rm change}$}
\psfrag{adiffthresh}{\scriptsize $\Delta  a_{\rm th}$}