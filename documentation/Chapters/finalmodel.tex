\chapter{Final model}
	...
	\section{Simulation of a traffic light situation}
		...
		Results of the simulation can be seen on Figure~\ref{fig:red_light_situationh_impr1}, \ref{fig:red_light_situationv_impr1} and \ref{fig:red_light_situationcc_impr1}. After implementing this improvement the overall duration has increased to \casetime{2}seconds. It can be seen clearly that the number of lane changes has increased. At the end however the number of cars in each lane has not changed.
		\begin{figure}
			\centering
