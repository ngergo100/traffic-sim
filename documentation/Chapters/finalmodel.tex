\chapter{Final model}
	...
	\section{Simulation of a traffic light situation}
		...
		Results of the simulation can be seen on Figure \ref{fig:red_light_situationh_impr2}, \ref{fig:red_light_situationv_impr2} and \ref{fig:red_light_situationcc_impr2}.
		\begin{figure}[ht]
			\centering
		...
		Results of the simulation can be seen on Figure \ref{fig:red_light_situationh_impr3}, \ref{fig:red_light_situationv_impr3} and \ref{fig:red_light_situationcc_impr3}.
		\begin{figure}[ht]
			\centering
