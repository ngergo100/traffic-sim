\chapter{Cases}
		...
		\section{Case 2}
			...
			\end{figure}
			\subsection*{Summary of the result}
			The results can be seen on Figure \ref{fig:red_light_situationh3}, \ref{fig:red_light_situationv3} and \ref{fig:red_light_situationcc3}. These plots show that the effect of adding an obstacle. The overall duration has increased drastically to \casetime{6}from the original \casetime{5}seconds. The link to the animation can be found in the appendix.
