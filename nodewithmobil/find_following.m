function car = find_following(sorted_traffic, current_car_data, source_lane)
...
my_index = find(traffic_in_my_lane(:,5) == current_car_data(5));
    ...
    if my_index > 1
        ...
        car = struct('position', leading_car_data(1),'velocity', leading_car_data(2), 'identifier',leading_car_data(5), 'L',leading_car_data(6));
    else
