...
for i=1:size(models, 1)
  ...
  mobil_params.left_lane = ismember(possible_left_lane, lane_numbers) * possible_left_lane;
  mobil_params.right_lane = ismember(possible_right_lane, lane_numbers) * possible_right_lane;
  ...
  if mobil_params.left_lane ~= 0 
      ...
      if left_following_car.identifier ~=0
        ...
        mobil_params.a_n_left = 0;
        mobil_params.b_max_left = -1;
      end
  else 
     mobil_params.a_c_left = 0;
     mobil_params.a_n_left = 0;
     mobil_params.b_max_left = -1;
  end
  ...
  if mobil_params.right_lane ~=0
      ...
      if right_following_car.identifier ~=0
        ...
        mobil_params.a_n_right = 0;
        mobil_params.b_max_right = -1;
      end
  else 
      mobil_params.a_c_right = 0;
      mobil_params.a_n_right = 0;
      mobil_params.b_max_right = -1;
  end
